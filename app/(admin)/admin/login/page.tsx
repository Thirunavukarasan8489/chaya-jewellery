...
import { Lock, Mail, Eye, EyeOff, ShieldCheck, Gem, Users, Boxes, BarChart3 } from 'lucide-react';
...
export default function AdminLogin() {
  ...
  return (
    <div className="min-h-screen w-full flex flex-col lg:flex-row bg-ivory-100 dark:bg-plum-950 selection:bg-plum-200 selection:text-plum-900">
      ...
      <div className="hidden lg:flex lg:w-[44%] xl:w-2/5 relative overflow-hidden bg-plum-950 text-ivory-100 flex-col justify-between p-12 shrink-0">
          ...
          <div className="bg-white dark:bg-plum-900 rounded-2xl shadow-lg border border-gray-200 dark:border-plum-800 p-6 sm:p-8">
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6" noValidate>
              ...
              <div className="space-y-4">
                ...
                <div>
                  <div className="flex items-center justify-between mb-1.5">
                    <label className="block text-sm font-medium text-plum-900 dark:text-ivory-100" htmlFor="password">
                      Password
                    </label>
                    <Link href="/admin/forgot-password" className="text-sm font-medium text-plum-600 dark:text-plum-300 hover:text-plum-900 dark:hover:text-white transition-colors">
                      Forgot password?
                    </Link>
                  </div>
                  <div className="relative">
              ...
              <div className="flex items-center">
                ...
                />
                <label htmlFor="rememberMe" className="ml-2 block text-sm text-plum-600 dark:text-plum-300">
                  Keep me signed in
                </label>
              </div>
