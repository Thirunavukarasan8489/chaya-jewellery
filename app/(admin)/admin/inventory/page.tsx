      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">
            Real-time stock availability, reservation tracking, and per-variant
            ...
            <div className="flex items-center justify-between border-b border-gray-100 dark:border-slate-800 pb-3">
              <div>
                ...
                <p className="text-xs text-gray-500">
                  {adjustingItem.name} — {adjustingItem.productName}
                </p>
              </div>
              <button
                  ...
                  {historyLoading ? (
                    ...
                    historyEntries.map((entry) => (
                      <tr key={entry._id}>
                        ...
                        <td
                          className={`px-4 py-2.5 text-center font-semibold whitespace-nowrap ${entry.adjustment >= 0 ? "text-emerald-600" : "text-red-600"}`}
                        >
                          {entry.adjustment >= 0 ? "+" : ""}
                          {entry.adjustment}
                        </td>
