  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white border border-gold-200 rounded-lg p-6">
        <h2 className="text-lg font-semibold text-gold-800 mb-4 pb-2 border-b">
          Announcement Bar
        </h2>
        <div className="flex items-center space-x-4">
          ...
          <input
            type="text"
            defaultValue="Free Shipping on all orders above ₹10,000"
            className="flex-1 border border-gold-300 rounded-md p-2 text-sm"
          />
        </div>
      </div>
      ...
      <div className="bg-white border border-gold-200 rounded-lg p-6">
        ...
        <div className="space-y-3">
          {sections.map((section) => (
            <div
              key={section.id}
              className="flex items-center justify-between p-4 border border-gold-200 rounded-md bg-gold-50"
            >
              <div className="flex items-center space-x-4">
