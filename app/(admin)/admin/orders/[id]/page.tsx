    ...
    <div className="p-6 max-w-8xl mx-auto space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          <Link
            href="/admin/orders"
            className="p-2 bg-slate-100 dark:bg-plum-800 hover:bg-slate-200 dark:hover:bg-plum-700 rounded-none transition-colors text-slate-600 dark:text-slate-300"
          >
                ...
                <tbody className="divide-y divide-gray-100 dark:divide-plum-800/50">
                  {order.items.map((item: any, idx: number) => {
                    ...
                    return (
                      <tr key={idx}>
                        <td className="py-4">
                          <div className="font-medium text-plum-900 dark:text-ivory-100">
                            {item.name}
                          </div>
                          {item.sku && (
                        ...
                        <td className="py-4 text-center text-slate-700 dark:text-slate-300">
                          {item.quantity}
                        </td>
                        <td className="py-4 text-right text-slate-700 dark:text-slate-300">
                          ₹{item.price.toLocaleString("en-IN")}
                        </td>
                        <td className="py-4 text-right font-medium text-plum-900 dark:text-ivory-100">
            ...
            <div className="p-6 space-y-3 text-sm">
              ...
              {order.gatewayPaymentId && (
                <div className="flex justify-between">
                  ...
                  <span className="font-mono text-xs text-plum-900 dark:text-ivory-100">
                    {order.gatewayPaymentId}
                  </span>
                </div>
              )}
