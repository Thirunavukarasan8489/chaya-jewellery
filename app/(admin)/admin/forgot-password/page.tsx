          ...
          {isSubmitted ? (
            <div className="text-center space-y-4">
              ...
              <div className="pt-4">
                <Link
                  href="/admin/login"
                  className="inline-flex justify-center items-center py-2 px-4 border border-gray-300 dark:border-plum-700 rounded-lg shadow-xs text-sm font-medium text-plum-900 dark:text-ivory-100 bg-white dark:bg-plum-800 hover:bg-gray-50 dark:hover:bg-plum-700 transition-colors"
                >
