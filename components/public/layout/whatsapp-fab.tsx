...
/**
 * Always-available enquiry shortcut. Sits opposite the cart's add-to-cart
...
export async function WhatsappFab() {
  ...
  return (
    <a
      ...
      className="fixed right-4 bottom-[calc(4.5rem+env(safe-area-inset-bottom)+0.75rem)] z-40 grid size-13 place-items-center rounded-full bg-[#25D366] text-white shadow-lg transition-transform duration-200 hover:scale-105 active:scale-95 lg:right-auto lg:bottom-6 lg:left-6"
    >
