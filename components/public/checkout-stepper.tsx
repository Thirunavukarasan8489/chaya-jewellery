...
export function CheckoutStepper() {
  ...
  const [purchaseType, setPurchaseType] = useState<"PERSONAL" | "BUSINESS">(
    "PERSONAL",
  );
  ...
  return (
    <div className="max-w-3xl mx-auto p-6 bg-white rounded-lg shadow-sm">
      ...
      <div className="flex items-center justify-between mb-8 border-b border-plum-200 pb-4">
        ...
        <div className="text-sm text-plum-600 font-medium">
          Step {step} of 4
        </div>
      </div>
        ...
        <div className="space-y-6 animate-rise">
          ...
          <div className="grid grid-cols-2 gap-4">
            <input
              ...
              className="border border-plum-200 rounded-md p-3"
            />
            <input
              type="tel"
            ...
            <input
              ...
              className="border border-plum-200 rounded-md p-3 col-span-2"
            />
          </div>

          <h3 className="text-lg font-semibold text-plum-900 mt-8">
            Purchase Type
          </h3>
          ...
          <button
            onClick={() => setStep(2)}
            className="w-full mt-6 bg-gold-500 hover:bg-gold-600 text-plum-950 font-bold py-3 rounded-md transition-colors"
          >
            Continue to Address
          </button>
        </div>
      ...
      {step === 2 && (
        <div className="space-y-6 animate-rise">
          ...
          <div className="flex space-x-4">
            <button
              onClick={() => setStep(1)}
              className="flex-1 py-3 border border-plum-300 text-plum-700 font-bold rounded-md"
            >
              Back
            </button>
            <button
              onClick={() => setStep(3)}
              className="flex-1 py-3 bg-gold-500 hover:bg-gold-600 text-plum-950 font-bold rounded-md"
            >
              Continue
            </button>
          </div>
      ...
      {step > 2 && (
        <div className="space-y-6 animate-rise">
          ...
          <div className="flex space-x-4">
            ...
            <button className="flex-1 py-3 bg-gold-500 hover:bg-gold-600 text-plum-950 font-bold rounded-md">
              Complete Order
            </button>
          </div>
        </div>
