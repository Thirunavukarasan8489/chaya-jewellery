...
export function PricingVariantsTab({
  ...
  const variantsError = !Array.isArray(errors.variants)
        ...
        <div className="border border-gray-200 dark:border-plum-700 rounded-xl overflow-hidden">
          {existingVariants.length === 0 ? (
            <div className="p-6 text-center text-sm text-rose-600 dark:text-rose-400">
              No variants yet for this product &mdash; add at least one before
              saving.
            </div>
          ) : (
          ...
          <div className="bg-white dark:bg-plum-900 rounded-xl shadow-lg max-w-md w-full overflow-hidden border border-gray-200 dark:border-plum-800">
            <div className="p-6">
              <div className="flex items-center gap-4 mb-4">
                <div className="w-10 h-10 rounded-none bg-rose-100 dark:bg-rose-900/30 flex items-center justify-center shrink-0">
