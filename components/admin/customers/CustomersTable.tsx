...
export default function CustomersTable({
  ...
  const columns = [
    ...
    },
    {
      header: "Type",
      cell: (item: CustomerRow) => (
        <span className="text-gold-600 dark:text-gold-400 text-sm capitalize">
  ...
  return (
    <DataTable title="Customer Directory" columns={columns} data={customers} />
  );
}
