...
export default function HeroSectionForm({
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    if (!formData.image && !selectedFile) {
      toast.error(
        "An image is required. Please upload an image or enter a URL.",
      );
      return;
    }
  ...
  return (
    <div className="max-w-8xl mx-auto space-y-6">
        ...
        <div>
          ...
          <p className="text-sm text-gold-500 dark:text-gold-400">
            {initialData
              ...
              : "Add a new slide to the public hero banner."}
          </p>
        </div>
      </div>
      ...
      <form
        ...
        className="bg-white dark:bg-gold-800 rounded-xl shadow-sm border border-gold-200 dark:border-gold-700 overflow-hidden p-6 space-y-8"
      >
        {/* Core Info */}
        <div className="space-y-4">
          <h2 className="text-lg font-semibold text-gold-800 dark:text-white border-b border-gold-100 dark:border-gold-700 pb-2">
            Basic Details
          </h2>

          <div className="grid grid-cols-1 gap-4">
            <div className="space-y-1">
              <label className="text-sm font-medium text-gold-700 dark:text-gold-300">
        ...
        <div className="space-y-4">
          ...
          <p className="text-xs text-gold-500 dark:text-gold-400 -mt-2">
            ...
            good for a pre-designed creative that already has its own text. Fill
            any of it in to overlay a badge/title/subtitle on top of the image.
          </p>
        ...
        <div className="space-y-4">
          ...
          <p className="text-xs text-gold-500 dark:text-gold-400 -mt-2">
            A button only appears if you fill in both its text and link. With no
            buttons and no content above, the whole banner image becomes
            clickable using the Primary Button Link below (e.g. link straight to
            a product or category). Text can be anything — Buy Now, Enquire Now,
            Shop the Collection, etc.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="space-y-1">
              ...
              <p className="text-xs text-gold-500 dark:text-gold-400">
                Also used as the redirect link for the whole image when no
                buttons or text are set.
              </p>
            </div>
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="flex items-center gap-3 pt-6">
              ...
              <label
                htmlFor="isActive"
                className="text-sm font-medium text-gold-700 dark:text-gold-300"
              >
