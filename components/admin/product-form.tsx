...
function FormSection({
  ...
  return (
    <div className="bg-white p-6 rounded-lg border border-gold-200 shadow-sm mb-6">
      <h3 className="text-lg font-semibold text-gold-800 mb-4 pb-2 border-b border-gold-100">
        {title}
      </h3>
  ...
  return (
    <form className="max-w-4xl">
      ...
      <div className="flex justify-end space-x-4 mt-6">
        <button
          type="button"
          className="px-4 py-2 border border-gold-300 rounded-md text-gold-700 hover:bg-gold-50"
        >
          Cancel
        </button>
        <button
          type="submit"
          className="px-4 py-2 bg-gold-900 text-white rounded-md hover:bg-gold-800"
        >
          Save Product
        </button>
      </div>
