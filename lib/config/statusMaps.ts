export const orderStatusConfig = {
  PAYMENT_PENDING: {
    ...
    nextAllowed: ["CONFIRMED", "CANCELLED"],
  },
  CONFIRMED: {
    label: "Confirmed",
    color: "bg-emerald-100 text-emerald-700",
    nextAllowed: ["PROCESSING", "CANCELLED"],
  },
  PROCESSING: {
    label: "Processing",
    color: "bg-blue-100 text-blue-700",
    nextAllowed: ["PACKED", "CANCELLED"],
  },
  PACKED: {
    label: "Packed",
  ...
  SHIPPED: {
    ...
    nextAllowed: ["OUT_FOR_DELIVERY"],
  },
  OUT_FOR_DELIVERY: {
    label: "Out for Delivery",
    color: "bg-teal-100 text-teal-700",
    nextAllowed: ["DELIVERED", "DELIVERY_FAILED"],
  },
  DELIVERED: {
    label: "Delivered",
    color: "bg-emerald-100 text-emerald-700",
    nextAllowed: ["RETURNED"],
  },
  CANCELLED: {
    label: "Cancelled",
